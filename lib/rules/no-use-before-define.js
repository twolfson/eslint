    ...
    create(context) {
        ...
        function findVariablesInScope(scope) {
            scope.references.forEach(reference => {
                 ...
                 * - referring to a global environment variable (there are no
                 *   identifiers).
                 * - not provided with range information, making the next check
                 *   impossible
                ...
                if (reference.init ||
                    ...
                    (!variable.identifiers[0].range || !reference.identifier.range) ||
